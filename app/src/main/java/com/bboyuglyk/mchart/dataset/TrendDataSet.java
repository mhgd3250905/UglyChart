...
public class TrendDataSet extends DataSet {
    private float foundNearRange = 20f;
    private RectF rectF;
    private @ColorInt
    int[] colors;
    ...
    public TrendDataSet(Context context, String tag, LinkedList<Entry> entries, int[] colors) {
    ...
    public TrendDataSet(Context context,String tag, LinkedList<Entry> entries) {
        super(context,tag, DataType.bar, entries);
        init();
    }
    ...
    private void init() {
        ...
        paint.setColor(Color.rgb(150, 150, 255));//线条粗细
        setPaint(paint);
        setShowMarker(true);
    }
