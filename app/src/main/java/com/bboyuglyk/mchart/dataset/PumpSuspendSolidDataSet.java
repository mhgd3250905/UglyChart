...
public class PumpSuspendSolidDataSet extends DataSet {
    public PumpSuspendSolidDataSet(Context context, String tag, LinkedList<Entry> entries) {
